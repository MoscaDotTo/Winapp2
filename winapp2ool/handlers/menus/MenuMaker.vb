...
Option Strict On
''' <summary> MenuMaker is a singleton driver module for powering dyanamic finite state console applications with numbered menus </summary>
...
Module MenuMaker
    ...
    ''' <param name="fillBorder"> Indicates whether or not any menu frames should be filled or be empty <br /> Optional, Default: <c> True (filled) </c> </param>
    ''' Docs last updated: 2020-09-04 | Code last updated: 2020-09-04
    ...
    ''' <summary> Determines which color should be used when printing. If no color is to be used, the print colors are reset to their defaults </summary>
    ''' <param name="colorLine"> Indicates that the line should be printed in color </param>
    ''' <param name="useArbColor"> Indicates that the value provided by <c> <paramref name="arbColor"/> </c> should be used </param>
    ''' <param name="arbColor"> A console color to print with </param>
    ''' <param name="enStrCond"> Determines Red/Green coloring when not using an <c> <paramref name="arbColor"/> </c></param>
    ''' Docs last updated: 2020-09-04 | Code last updated: 2020-09-04
    ...
    ''' <param name="fillConjoiner"> Indicates that the conjoining frame at the bottom of the menu headed should be filled <br /> Optional, Default: <c> True (Filled)</c> </param>
    ''' Docs last updated: 2020-09-04 | Code last updated: 2020-09-04
    ...
    ''' </list>
    ''' <br/> Optional, Default: <c> 0 </c> </param>
    ''' <param name="fillBorder"> Indicates that top and bottom borders should be printed when printing menuframes </param>
    ''' Docs last updated: 2020-09-04 | Code last updated: 2020-09-04
