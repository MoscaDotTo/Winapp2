...
Public Class iniKey
    ...
    ''' <summary>
    ''' The type of the iniKey: any text on the left side of the '=' (not including numbers)
    ''' </summary>
    Public Property KeyType As String

    ''' <summary>
    ''' The name of the iniKey: any text on the left side of the '='
    ''' </summary>
    Public Property Name As String

    ''' <summary>
    ''' The number of the line on which the key was found during the original reading of the file
    ''' </summary>
    ...
    ''' 
    ''' <param name="n">
    ''' The String to check equality for
    ''' </param>
    ''' 
    ''' <param name="ignoreCase">
    ''' Optional boolean specifying whether or not the casing of the strings should be ignored (default false)
    ''' </param>
    Public Function nameIs(n As String,
    ...
    ''' Optional boolean specifying whether or not the casing of the strings should be ignored (default false)
    ''' </param>
    Public Function typeIs(t As String,
                  Optional ignoreCase As Boolean = False) As Boolean
    ...
    ''' Optional boolean specifying whether or not the casing of the strings should be ignored (default false)
    ''' </param>
    Public Function vHas(txt As String,
                Optional ignoreCase As Boolean = False) As Boolean
    ...
    ''' 
    ''' <param name="txts">
    ''' The array of search strings
    ''' </param>
    ''' 
    ''' <param name="ignoreCase">
    ''' Optional boolean specifying whether or not the casing of the strings should be ignored (default false)
    ''' </param>
    Public Function vHasAny(txts As String(),
                   Optional ignoreCase As Boolean = False) As Boolean
    ...
    ''' Optional boolean specifying whether or not the casing of the strings should be ignored (default false)
    ''' </param>
    Public Function vIs(txt As String,
               Optional ignoreCase As Boolean = False) As Boolean
    ...
    ''' 
    ''' <param name="keyName">
    ''' The string containing the iniKey's keyname
    ''' </param>
    ...
    ''' 
    ''' <param name="count">
    ''' The line number for the string
    ''' </param>
