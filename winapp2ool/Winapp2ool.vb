...
Module Winapp2ool
    ...
    Private Sub printToolSettingsMenu()
        ...
        print(5, "Toggle Update Checking", "automatic update checking for winapp2ool beta", enStrCond:=autoCheckBetaToolUpdates, closeMenu:=Not toolSettingsHaveChanged, cond:=isBeta)
